...
/**
 * Generated class for the AddNormsPage page.
 *
...
export class AddNormsPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams,public alertCtrl: AlertController,public formBuilder: FormBuilder,  public fdb: AngularFireDatabase) {
  ...
  onSubmit(value: any): void {
    this.fdb.list("/society_rules/").push({ 'rule': this.rule.value, 'rule_type': this.rType.value})
    .then(data => {
