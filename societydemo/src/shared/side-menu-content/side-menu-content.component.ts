...
export class SideMenuContentComponent {
  ...
  set settings(value: SideMenuSettings) {
    if (value) {
      ...
      if (!this.menuSettings.showSelectedOption && this.selectedOption) {
        let parent = this.parents.get(
          this.selectedOption.displayName.toLowerCase()
        );
    ...
    this.menuOptions.forEach(option => {
      if (option.displayName.toLowerCase() === data.displayName.toLowerCase()) {
        ...
        if (option.subItems) {
          option.subItems.forEach(subItem => {
            if (
              subItem.displayName.toLowerCase() ===
  ...
  private mergeSettings(): void {
    ...
    if (!this.menuSettings.itemHeight) {
      ...
      this.menuSettings.itemHeight.ios = this.isDefinedAndPositive(
        this.menuSettings.itemHeight.ios
      )
        ? this.menuSettings.itemHeight.ios
        : defaultSettings.itemHeight.ios;
      this.menuSettings.itemHeight.md = this.isDefinedAndPositive(
        this.menuSettings.itemHeight.md
      )
        ? this.menuSettings.itemHeight.md
        : defaultSettings.itemHeight.md;
      this.menuSettings.itemHeight.wp = this.isDefinedAndPositive(
        this.menuSettings.itemHeight.wp
      )
        ? this.menuSettings.itemHeight.wp
    ...
    this.menuSettings.subOptionIndentation = this.isDefined(
    ...
    if (!this.menuSettings.subOptionIndentation) {
      ...
      this.menuSettings.subOptionIndentation.ios = this.isDefined(
        this.menuSettings.subOptionIndentation.ios
      )
        ? this.menuSettings.subOptionIndentation.ios
        : defaultSettings.subOptionIndentation.ios;
      this.menuSettings.subOptionIndentation.md = this.isDefined(
        this.menuSettings.subOptionIndentation.md
      )
        ? this.menuSettings.subOptionIndentation.md
        : defaultSettings.subOptionIndentation.md;
      this.menuSettings.subOptionIndentation.wp = this.isDefined(
